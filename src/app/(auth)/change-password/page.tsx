...
export default async function ChangePasswordPage() {
  ...
  return <AuthPageFrame><AuthCard eyebrow="Seguridad de la cuenta" title={profile.must_change_password ? "Cambio obligatorio" : "Cambiar contraseña"} description={profile.must_change_password ? "Tu acceso fue creado con una credencial temporal. Definí una contraseña personal antes de continuar." : "Definí una contraseña nueva y segura para tu cuenta."}><ChangePasswordForm successHref={roleDestination(profile.role)} /></AuthCard></AuthPageFrame>;
}
