...
CREATE OR REPLACE FUNCTION "public"."assert_superadmin_catalog"() RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
...
ALTER FUNCTION "public"."assert_superadmin_catalog"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."confirmar_recepcion_dispositivo"("p_dispositivo_cliente_id" "uuid", "p_problema_informado" "text", "p_observaciones" "text", "p_resultados" "jsonb", "p_intake_metadata" "jsonb") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
...
ALTER FUNCTION "public"."confirmar_recepcion_dispositivo"("p_dispositivo_cliente_id" "uuid", "p_problema_informado" "text", "p_observaciones" "text", "p_resultados" "jsonb", "p_intake_metadata" "jsonb") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."is_valid_imei"("p_imei" "text") RETURNS boolean
    LANGUAGE "sql" IMMUTABLE STRICT
    SET "search_path" TO ''
    AS $_$
...
ALTER FUNCTION "public"."is_valid_imei"("p_imei" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."master_catalog_health"("p_device_type_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
...
ALTER FUNCTION "public"."master_catalog_health"("p_device_type_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."save_customer_device_step_two"("p_customer_id" "uuid", "p_device_type_id" "uuid", "p_device_brand_id" "uuid", "p_device_model_id" "uuid", "p_serial_number" "text" DEFAULT NULL::"text", "p_observations" "text" DEFAULT NULL::"text", "p_customer_device_id" "uuid" DEFAULT NULL::"uuid", "p_attributes" "jsonb" DEFAULT '{}'::"jsonb", "p_ram_modules" "jsonb" DEFAULT '[]'::"jsonb", "p_storage_drives" "jsonb" DEFAULT '[]'::"jsonb", "p_ports" "jsonb" DEFAULT '[]'::"jsonb", "p_accessory_ids" "uuid"[] DEFAULT '{}'::"uuid"[], "p_imeis" "jsonb" DEFAULT '[]'::"jsonb", "p_mobile_specs" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
...
ALTER FUNCTION "public"."save_customer_device_step_two"("p_customer_id" "uuid", "p_device_type_id" "uuid", "p_device_brand_id" "uuid", "p_device_model_id" "uuid", "p_serial_number" "text", "p_observations" "text", "p_customer_device_id" "uuid", "p_attributes" "jsonb", "p_ram_modules" "jsonb", "p_storage_drives" "jsonb", "p_ports" "jsonb", "p_accessory_ids" "uuid"[], "p_imeis" "jsonb", "p_mobile_specs" "jsonb") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."superadmin_create_device_brand"("p_name" "text", "p_device_type_ids" "uuid"[]) RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
...
ALTER FUNCTION "public"."superadmin_create_device_brand"("p_name" "text", "p_device_type_ids" "uuid"[]) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."superadmin_create_device_color"("p_name" "text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare v_actor uuid:=public.assert_superadmin_catalog(); v_id uuid; v_name text:=regexp_replace(btrim(coalesce(p_name,'')),'\s+',' ','g');
...
ALTER FUNCTION "public"."superadmin_create_device_color"("p_name" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."superadmin_create_device_model"("p_device_type_id" "uuid", "p_brand_id" "uuid", "p_name" "text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare v_actor uuid := public.assert_superadmin_catalog(); v_id uuid; v_name text := regexp_replace(btrim(coalesce(p_name,'')),'\s+',' ','g');
...
ALTER FUNCTION "public"."superadmin_create_device_model"("p_device_type_id" "uuid", "p_brand_id" "uuid", "p_name" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."superadmin_create_device_variant"("p_model_id" "uuid", "p_name" "text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare v_actor uuid := public.assert_superadmin_catalog(); v_id uuid; v_name text := regexp_replace(btrim(coalesce(p_name,'')),'\s+',' ','g');
...
ALTER FUNCTION "public"."superadmin_create_device_variant"("p_model_id" "uuid", "p_name" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."superadmin_create_gpu_brand"("p_name" "text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
...
ALTER FUNCTION "public"."superadmin_create_gpu_brand"("p_name" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."superadmin_create_gpu_family"("p_brand_id" "uuid", "p_name" "text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare v_id uuid; v_name text:=regexp_replace(btrim(coalesce(p_name,'')),'\s+',' ','g'); v_code text;
...
ALTER FUNCTION "public"."superadmin_create_gpu_family"("p_brand_id" "uuid", "p_name" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."superadmin_create_gpu_model"("p_family_id" "uuid", "p_name" "text", "p_graphics_kind" "text", "p_notebook" boolean, "p_desktop" boolean) RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare v_id uuid; v_name text:=regexp_replace(btrim(coalesce(p_name,'')),'\s+',' ','g'); v_code text;
...
ALTER FUNCTION "public"."superadmin_create_gpu_model"("p_family_id" "uuid", "p_name" "text", "p_graphics_kind" "text", "p_notebook" boolean, "p_desktop" boolean) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."superadmin_create_motherboard_manufacturer"("p_name" "text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare v_actor uuid:=public.assert_superadmin_catalog(); v_id uuid; v_name text:=regexp_replace(btrim(coalesce(p_name,'')),'\s+',' ','g');
...
ALTER FUNCTION "public"."superadmin_create_motherboard_manufacturer"("p_name" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."superadmin_create_motherboard_model"("p_manufacturer_id" "uuid", "p_name" "text", "p_device_type_ids" "uuid"[]) RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare v_actor uuid:=public.assert_superadmin_catalog(); v_id uuid; v_name text:=regexp_replace(btrim(coalesce(p_name,'')),'\s+',' ','g');
...
ALTER FUNCTION "public"."superadmin_create_motherboard_model"("p_manufacturer_id" "uuid", "p_name" "text", "p_device_type_ids" "uuid"[]) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."superadmin_create_processor_model"("p_brand_id" "uuid", "p_family_id" "uuid", "p_generation_id" "uuid", "p_name" "text", "p_notebook" boolean, "p_desktop" boolean) RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare v_actor uuid := public.assert_superadmin_catalog(); v_id uuid; v_name text := regexp_replace(btrim(coalesce(p_name,'')),'\s+',' ','g');
...
ALTER FUNCTION "public"."superadmin_create_processor_model"("p_brand_id" "uuid", "p_family_id" "uuid", "p_generation_id" "uuid", "p_name" "text", "p_notebook" boolean, "p_desktop" boolean) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."superadmin_create_ram_speed"("p_ram_type_id" "uuid", "p_mhz" integer) RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare v_id uuid;
...
ALTER FUNCTION "public"."superadmin_create_ram_speed"("p_ram_type_id" "uuid", "p_mhz" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."superadmin_create_ram_type"("p_code" "text", "p_name" "text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare v_id uuid;
...
ALTER FUNCTION "public"."superadmin_create_ram_type"("p_code" "text", "p_name" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."superadmin_create_reception_control"("p_key" "text", "p_label" "text", "p_description" "text", "p_critical" boolean, "p_device_type_ids" "uuid"[]) RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare v_id uuid;
...
ALTER FUNCTION "public"."superadmin_create_reception_control"("p_key" "text", "p_label" "text", "p_description" "text", "p_critical" boolean, "p_device_type_ids" "uuid"[]) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."superadmin_create_storage_option"("p_entity" "text", "p_code" "text", "p_name" "text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare v_id uuid;
...
ALTER FUNCTION "public"."superadmin_create_storage_option"("p_entity" "text", "p_code" "text", "p_name" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."superadmin_set_catalog_active"("p_entity" "text", "p_id" "uuid", "p_active" boolean) RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
begin
...
ALTER FUNCTION "public"."superadmin_set_catalog_active"("p_entity" "text", "p_id" "uuid", "p_active" boolean) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."validate_service_order_technician"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    SET "search_path" TO ''
    AS $$
declare v_user uuid; v_org uuid;
begin
  if tg_table_name='service_orders' then v_user:=new.primary_technician_id; v_org:=new.organization_id;
  elsif tg_table_name='service_order_assignments' then v_user:=new.technician_user_id; v_org:=new.organization_id;
  elsif tg_table_name='service_order_time_entries' then v_user:=new.technician_user_id; v_org:=new.organization_id;
  elsif tg_table_name='service_order_tasks' then v_user:=new.assigned_technician_id; v_org:=new.organization_id;
  else return new; end if;
  if v_user is not null and not exists(select 1 from public.profiles p where p.id=v_user and p.organization_id=v_org and p.role='TECHNICIAN' and p.status='ACTIVE') then
    raise exception 'TECHNICIAN_NOT_ACTIVE_IN_ORGANIZATION';
  end if;
  return new;
end $$;


ALTER FUNCTION "public"."validate_service_order_technician"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."customer_communications" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "customer_communications_channel_check" CHECK (("channel" = ANY (ARRAY['IN_PERSON'::"text", 'PHONE'::"text", 'WHATSAPP'::"text", 'EMAIL'::"text", 'PORTAL'::"text", 'OTHER'::"text"]))),
    CONSTRAINT "customer_communications_direction_check" CHECK (("direction" = ANY (ARRAY['INBOUND'::"text", 'OUTBOUND'::"text", 'INTERNAL'::"text"]))),
    CONSTRAINT "customer_communications_message_check" CHECK ((("char_length"("btrim"("message")) >= 1) AND ("char_length"("btrim"("message")) <= 5000))),
    CONSTRAINT "customer_communications_subject_check" CHECK ((("subject" IS NULL) OR ("char_length"("subject") <= 200)))
);
...
CREATE TABLE IF NOT EXISTS "public"."customer_device_imeis" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    ...
    CONSTRAINT "customer_device_imeis_position_check" CHECK ((("position" >= 1) AND ("position" <= 99)))
);


ALTER TABLE "public"."customer_device_imeis" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."customer_device_mobile_specs" (
    "fk_customer_device_id" "uuid" NOT NULL,
    "fk_organizacion_id" "uuid" NOT NULL,
    "ram_mb" integer,
    "internal_storage_gb" integer,
    "sd_card_present" boolean DEFAULT false NOT NULL,
    "sd_card_capacity_gb" integer,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "ck_mobile_specs_sd_capacity" CHECK (("sd_card_present" OR ("sd_card_capacity_gb" IS NULL))),
    CONSTRAINT "customer_device_mobile_specs_internal_storage_gb_check" CHECK ((("internal_storage_gb" IS NULL) OR (("internal_storage_gb" >= 1) AND ("internal_storage_gb" <= 16384)))),
    CONSTRAINT "customer_device_mobile_specs_ram_mb_check" CHECK ((("ram_mb" IS NULL) OR (("ram_mb" >= 128) AND ("ram_mb" <= 262144)))),
    CONSTRAINT "customer_device_mobile_specs_sd_card_capacity_gb_check" CHECK ((("sd_card_capacity_gb" IS NULL) OR (("sd_card_capacity_gb" >= 1) AND ("sd_card_capacity_gb" <= 4096))))
);


ALTER TABLE "public"."customer_device_mobile_specs" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."device_receptions" (
    ...
    "access_method" "text",
    "credential_provided" boolean DEFAULT false NOT NULL,
    CONSTRAINT "ck_device_receptions_access_consistency" CHECK ((("access_available" IS DISTINCT FROM false) OR (("access_method" IS NULL) AND ("credential_provided" = false)))),
    CONSTRAINT "ck_device_receptions_access_method" CHECK ((("access_method" IS NULL) OR ("access_method" = ANY (ARRAY['UNLOCKED'::"text", 'PIN'::"text", 'PATTERN'::"text", 'PASSWORD'::"text", 'BIOMETRIC'::"text", 'OTHER'::"text"])))),
    CONSTRAINT "ck_device_receptions_charge_state" CHECK ((("charge_state" IS NULL) OR ("charge_state" = ANY (ARRAY['CHARGES'::"text", 'INTERMITTENT'::"text", 'DOES_NOT_CHARGE'::"text", 'NOT_TESTED'::"text"])))),
    CONSTRAINT "ck_device_receptions_image_state" CHECK ((("image_state" IS NULL) OR ("image_state" = ANY (ARRAY['HAS_IMAGE'::"text", 'NO_IMAGE'::"text", 'NOT_TESTED'::"text", 'NOT_APPLICABLE'::"text"])))),
    CONSTRAINT "ck_device_receptions_power_state" CHECK ((("power_state" IS NULL) OR ("power_state" = ANY (ARRAY['POWERS_ON'::"text", 'DOES_NOT_POWER_ON'::"text", 'NOT_TESTED'::"text"])))),
...
CREATE TABLE IF NOT EXISTS "public"."motherboard_chipsets" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "fk_processor_socket_id" "uuid" NOT NULL,
    "code" "text" NOT NULL,
    "name" "text" NOT NULL,
    "is_active" boolean DEFAULT true NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
...
ALTER TABLE "public"."motherboard_chipsets" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."motherboard_form_factors" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "code" "text" NOT NULL,
    "name" "text" NOT NULL,
    "is_active" boolean DEFAULT true NOT NULL,
...
ALTER TABLE "public"."motherboard_form_factors" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."motherboard_models" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "fk_processor_socket_id" "uuid",
    "fk_motherboard_chipset_id" "uuid",
    "fk_ram_type_id" "uuid",
    "fk_motherboard_form_factor_id" "uuid",
    "lifecycle_status" "text" DEFAULT 'CURRENT'::"text" NOT NULL,
    "search_priority" integer DEFAULT 0 NOT NULL,
    ...
    CONSTRAINT "motherboard_models_lifecycle_status_check" CHECK (("lifecycle_status" = ANY (ARRAY['CURRENT'::"text", 'LEGACY'::"text", 'DISCONTINUED'::"text"]))),
    CONSTRAINT "motherboard_models_search_priority_check" CHECK (("search_priority" >= 0))
);
...
CREATE TABLE IF NOT EXISTS "public"."organization_labor_rates" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "organization_id" "uuid" NOT NULL,
    "name" "text" NOT NULL,
    "hourly_cost" numeric(14,2) NOT NULL,
    "hourly_sale_rate" numeric(14,2) NOT NULL,
    "valid_from" timestamp with time zone DEFAULT "now"() NOT NULL,
    "valid_until" timestamp with time zone,
    "is_active" boolean DEFAULT true NOT NULL,
    "created_by" "uuid" DEFAULT "auth"."uid"(),
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "organization_labor_rates_check" CHECK ((("valid_until" IS NULL) OR ("valid_until" > "valid_from"))),
    CONSTRAINT "organization_labor_rates_hourly_cost_check" CHECK (("hourly_cost" >= (0)::numeric)),
    CONSTRAINT "organization_labor_rates_hourly_sale_rate_check" CHECK (("hourly_sale_rate" >= (0)::numeric)),
    CONSTRAINT "organization_labor_rates_name_check" CHECK ((("char_length"("btrim"("name")) >= 2) AND ("char_length"("btrim"("name")) <= 100)))
);


ALTER TABLE "public"."organization_labor_rates" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."payment_methods" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "payment_methods_code_check" CHECK ((("code" = "upper"("code")) AND ("code" ~ '^[A-Z][A-Z0-9_]*$'::"text"))),
...
CREATE TABLE IF NOT EXISTS "public"."processor_sockets" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "processor_sockets_platform_check" CHECK (("platform" = ANY (ARRAY['AMD'::"text", 'INTEL'::"text"])))
);


ALTER TABLE "public"."processor_sockets" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."service_complexity_levels" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "organization_id" "uuid",
    "code" "text" NOT NULL,
    "name" "text" NOT NULL,
    "labor_multiplier" numeric(8,4) DEFAULT 1 NOT NULL,
    "sort_order" smallint DEFAULT 0 NOT NULL,
    "is_active" boolean DEFAULT true NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "service_complexity_levels_code_check" CHECK ((("code" = "upper"("code")) AND ("code" ~ '^[A-Z][A-Z0-9_]*$'::"text"))),
    CONSTRAINT "service_complexity_levels_labor_multiplier_check" CHECK (("labor_multiplier" > (0)::numeric)),
    CONSTRAINT "service_complexity_levels_sort_order_check" CHECK (("sort_order" >= 0))
);


ALTER TABLE "public"."service_complexity_levels" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."service_order_assignments" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "organization_id" "uuid" NOT NULL,
    "service_order_id" "uuid" NOT NULL,
    "technician_user_id" "uuid" NOT NULL,
    "assignment_role" "text" DEFAULT 'TECHNICIAN'::"text" NOT NULL,
    "assigned_by" "uuid" DEFAULT "auth"."uid"(),
    "assigned_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "unassigned_at" timestamp with time zone,
    CONSTRAINT "service_order_assignments_assignment_role_check" CHECK (("assignment_role" = ANY (ARRAY['RECEPTION'::"text", 'DIAGNOSIS'::"text", 'TECHNICIAN'::"text", 'TESTING'::"text", 'LEAD'::"text"]))),
    CONSTRAINT "service_order_assignments_check" CHECK ((("unassigned_at" IS NULL) OR ("unassigned_at" >= "assigned_at")))
);


ALTER TABLE "public"."service_order_assignments" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."service_order_deliveries" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "organization_id" "uuid" NOT NULL,
    "service_order_id" "uuid" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "service_order_deliveries_final_observations_check" CHECK ((("final_observations" IS NULL) OR ("char_length"("final_observations") <= 3000))),
    CONSTRAINT "service_order_deliveries_received_by_name_check" CHECK ((("char_length"("btrim"("received_by_name")) >= 2) AND ("char_length"("btrim"("received_by_name")) <= 170)))
);


ALTER TABLE "public"."service_order_deliveries" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."service_order_expenses" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "organization_id" "uuid" NOT NULL,
    "service_order_id" "uuid" NOT NULL,
    ...
    "created_by" "uuid" DEFAULT "auth"."uid"(),
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "service_order_expenses_amount_check" CHECK (("amount" >= (0)::numeric)),
    CONSTRAINT "service_order_expenses_description_check" CHECK ((("char_length"("btrim"("description")) >= 2) AND ("char_length"("btrim"("description")) <= 500))),
    CONSTRAINT "service_order_expenses_expense_type_check" CHECK (("expense_type" = ANY (ARRAY['SHIPPING'::"text", 'COURIER'::"text", 'OUTSOURCED_SERVICE'::"text", 'SPECIAL_PURCHASE'::"text", 'OTHER'::"text"])))
);


ALTER TABLE "public"."service_order_expenses" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."service_order_parts" (
    ...
    "created_by" "uuid" DEFAULT "auth"."uid"(),
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "service_order_parts_quantity_check" CHECK (("quantity" > (0)::numeric)),
    CONSTRAINT "service_order_parts_unit_cost_check" CHECK (("unit_cost" >= (0)::numeric)),
    CONSTRAINT "service_order_parts_unit_sale_price_check" CHECK (("unit_sale_price" >= (0)::numeric))
);
...
CREATE TABLE IF NOT EXISTS "public"."service_order_payments" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "service_order_payments_amount_check" CHECK (("amount" > (0)::numeric)),
    CONSTRAINT "service_order_payments_reference_check" CHECK ((("reference" IS NULL) OR ("char_length"("reference") <= 200))),
    CONSTRAINT "service_order_payments_status_check" CHECK (("status" = ANY (ARRAY['PENDING'::"text", 'CONFIRMED'::"text", 'VOIDED'::"text", 'REFUNDED'::"text"])))
);


ALTER TABLE "public"."service_order_payments" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."service_order_pricing" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "organization_id" "uuid" NOT NULL,
    "service_order_id" "uuid" NOT NULL,
    ...
    "suggested_labor_price" numeric(14,2) DEFAULT 0 NOT NULL,
    "suggested_parts_price" numeric(14,2) DEFAULT 0 NOT NULL,
    "suggested_total" numeric(14,2) DEFAULT 0 NOT NULL,
    "final_price" numeric(14,2),
    "priority_multiplier" numeric(8,4) DEFAULT 1 NOT NULL,
    "complexity_multiplier" numeric(8,4) DEFAULT 1 NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "service_order_pricing_base_cost_check" CHECK (("base_cost" >= (0)::numeric)),
    CONSTRAINT "service_order_pricing_complexity_multiplier_check" CHECK (("complexity_multiplier" > (0)::numeric)),
    CONSTRAINT "service_order_pricing_customer_response_channel_check" CHECK ((("customer_response_channel" IS NULL) OR ("customer_response_channel" = ANY (ARRAY['IN_PERSON'::"text", 'PHONE'::"text", 'WHATSAPP'::"text", 'EMAIL'::"text", 'PORTAL'::"text", 'OTHER'::"text"])))),
    CONSTRAINT "service_order_pricing_customer_response_note_check" CHECK ((("customer_response_note" IS NULL) OR ("char_length"("customer_response_note") <= 2000))),
    CONSTRAINT "service_order_pricing_final_price_check" CHECK ((("final_price" IS NULL) OR ("final_price" >= (0)::numeric))),
    CONSTRAINT "service_order_pricing_labor_cost_check" CHECK (("labor_cost" >= (0)::numeric)),
    CONSTRAINT "service_order_pricing_labor_minutes_check" CHECK (("labor_minutes" >= 0)),
    CONSTRAINT "service_order_pricing_other_cost_check" CHECK (("other_cost" >= (0)::numeric)),
    CONSTRAINT "service_order_pricing_parts_cost_check" CHECK (("parts_cost" >= (0)::numeric)),
    CONSTRAINT "service_order_pricing_pricing_policy_version_check" CHECK (("pricing_policy_version" > 0)),
    CONSTRAINT "service_order_pricing_priority_multiplier_check" CHECK (("priority_multiplier" > (0)::numeric)),
    CONSTRAINT "service_order_pricing_status_check" CHECK (("status" = ANY (ARRAY['CALCULATED'::"text", 'PROPOSED'::"text", 'APPROVED'::"text", 'REJECTED'::"text", 'SUPERSEDED'::"text", 'FINAL'::"text"]))),
    CONSTRAINT "service_order_pricing_suggested_labor_price_check" CHECK (("suggested_labor_price" >= (0)::numeric)),
    CONSTRAINT "service_order_pricing_suggested_parts_price_check" CHECK (("suggested_parts_price" >= (0)::numeric)),
    CONSTRAINT "service_order_pricing_suggested_total_check" CHECK (("suggested_total" >= (0)::numeric)),
    CONSTRAINT "service_order_pricing_version_check" CHECK (("version" > 0))
);


ALTER TABLE "public"."service_order_pricing" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."service_order_pricing_adjustments" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "service_order_pricing_id" "uuid" NOT NULL,
    ...
    "created_by" "uuid" DEFAULT "auth"."uid"(),
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "service_order_pricing_adjustments_adjustment_type_check" CHECK (("adjustment_type" = ANY (ARRAY['DISCOUNT'::"text", 'SURCHARGE'::"text", 'ROUNDING'::"text", 'OTHER'::"text"]))),
    CONSTRAINT "service_order_pricing_adjustments_amount_check" CHECK ((("amount" IS NULL) OR ("amount" >= (0)::numeric))),
    CONSTRAINT "service_order_pricing_adjustments_check" CHECK ((((("amount" IS NOT NULL))::integer + (("percentage" IS NOT NULL))::integer) = 1)),
    CONSTRAINT "service_order_pricing_adjustments_description_check" CHECK ((("char_length"("btrim"("description")) >= 2) AND ("char_length"("btrim"("description")) <= 500))),
    CONSTRAINT "service_order_pricing_adjustments_percentage_check" CHECK ((("percentage" IS NULL) OR ("percentage" >= (0)::numeric)))
);


ALTER TABLE "public"."service_order_pricing_adjustments" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."service_order_priorities" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "organization_id" "uuid",
    "code" "text" NOT NULL,
    "name" "text" NOT NULL,
    ...
    "is_active" boolean DEFAULT true NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "service_order_priorities_code_check" CHECK ((("code" = "upper"("code")) AND ("code" ~ '^[A-Z][A-Z0-9_]*$'::"text"))),
    CONSTRAINT "service_order_priorities_labor_multiplier_check" CHECK (("labor_multiplier" > (0)::numeric)),
    CONSTRAINT "service_order_priorities_sort_order_check" CHECK (("sort_order" >= 0))
);


ALTER TABLE "public"."service_order_priorities" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."service_order_status_history" (
    ...
    "note" "text",
    CONSTRAINT "service_order_status_history_note_check" CHECK ((("note" IS NULL) OR ("char_length"("note") <= 1000)))
);
...
CREATE TABLE IF NOT EXISTS "public"."service_order_statuses" (
    ...
    "is_active" boolean DEFAULT true NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "service_order_statuses_code_check" CHECK ((("code" = "upper"("code")) AND ("code" ~ '^[A-Z][A-Z0-9_]*$'::"text"))),
    CONSTRAINT "service_order_statuses_name_check" CHECK ((("char_length"("btrim"("name")) >= 2) AND ("char_length"("btrim"("name")) <= 80))),
    CONSTRAINT "service_order_statuses_sort_order_check" CHECK (("sort_order" >= 0))
);


ALTER TABLE "public"."service_order_statuses" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."service_order_tasks" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "service_order_tasks_check" CHECK ((("completed_at" IS NULL) OR ("started_at" IS NULL) OR ("completed_at" >= "started_at"))),
    CONSTRAINT "service_order_tasks_description_check" CHECK ((("description" IS NULL) OR ("char_length"("description") <= 4000))),
    CONSTRAINT "service_order_tasks_status_check" CHECK (("status" = ANY (ARRAY['PENDING'::"text", 'IN_PROGRESS'::"text", 'BLOCKED'::"text", 'COMPLETED'::"text", 'CANCELLED'::"text"]))),
    CONSTRAINT "service_order_tasks_title_check" CHECK ((("char_length"("btrim"("title")) >= 2) AND ("char_length"("btrim"("title")) <= 160)))
);


ALTER TABLE "public"."service_order_tasks" OWNER TO "postgres";
...
CASE
    ...
    ELSE GREATEST(0, ("floor"((EXTRACT(epoch FROM ("ended_at" - "started_at")) / (60)::numeric)))::integer)
END) STORED,
    "notes" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "service_order_time_entries_check" CHECK ((("ended_at" IS NULL) OR ("ended_at" >= "started_at"))),
    CONSTRAINT "service_order_time_entries_notes_check" CHECK ((("notes" IS NULL) OR ("char_length"("notes") <= 2000)))
);


ALTER TABLE "public"."service_order_time_entries" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."service_order_warranties" (
    ...
    "created_by" "uuid" DEFAULT "auth"."uid"(),
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "service_order_warranties_check" CHECK (("expires_at" > "starts_at")),
    CONSTRAINT "service_order_warranties_status_check" CHECK (("status" = ANY (ARRAY['ACTIVE'::"text", 'EXPIRED'::"text", 'VOIDED'::"text"]))),
    CONSTRAINT "service_order_warranties_terms_check" CHECK ((("terms" IS NULL) OR ("char_length"("terms") <= 4000)))
);


ALTER TABLE "public"."service_order_warranties" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."service_orders" (
    ...
    "technical_completed_at" timestamp with time zone,
    "closed_at" timestamp with time zone,
    "created_by" "uuid" DEFAULT "auth"."uid"(),
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "service_orders_check" CHECK ((("technical_completed_at" IS NULL) OR ("technical_completed_at" >= "opened_at"))),
    CONSTRAINT "service_orders_check1" CHECK ((("closed_at" IS NULL) OR ("closed_at" >= "opened_at"))),
    CONSTRAINT "service_orders_internal_notes_check" CHECK ((("internal_notes" IS NULL) OR ("char_length"("internal_notes") <= 5000))),
    CONSTRAINT "service_orders_order_number_check" CHECK (("order_number" > 0))
);
...
ALTER TABLE ONLY "public"."customer_device_imeis"
    ADD CONSTRAINT "customer_device_imeis_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."customer_device_mobile_specs"
    ADD CONSTRAINT "customer_device_mobile_specs_pkey" PRIMARY KEY ("fk_customer_device_id");
...
ALTER TABLE ONLY "public"."motherboard_chipsets"
    ADD CONSTRAINT "motherboard_chipsets_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."motherboard_form_factors"
    ADD CONSTRAINT "motherboard_form_factors_code_key" UNIQUE ("code");



ALTER TABLE ONLY "public"."motherboard_form_factors"
    ADD CONSTRAINT "motherboard_form_factors_name_key" UNIQUE ("name");



ALTER TABLE ONLY "public"."motherboard_form_factors"
    ADD CONSTRAINT "motherboard_form_factors_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."organization_labor_rates"
    ADD CONSTRAINT "organization_labor_rates_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."payment_methods"
    ADD CONSTRAINT "payment_methods_organization_id_code_key" UNIQUE NULLS NOT DISTINCT ("organization_id", "code");
...
ALTER TABLE ONLY "public"."processor_sockets"
    ADD CONSTRAINT "processor_sockets_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."service_complexity_levels"
    ADD CONSTRAINT "service_complexity_levels_organization_id_code_key" UNIQUE NULLS NOT DISTINCT ("organization_id", "code");



ALTER TABLE ONLY "public"."service_complexity_levels"
    ADD CONSTRAINT "service_complexity_levels_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."service_order_deliveries"
    ADD CONSTRAINT "service_order_deliveries_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."service_order_deliveries"
    ADD CONSTRAINT "service_order_deliveries_service_order_id_key" UNIQUE ("service_order_id");



ALTER TABLE ONLY "public"."service_order_expenses"
    ADD CONSTRAINT "service_order_expenses_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."service_order_payments"
    ADD CONSTRAINT "service_order_payments_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."service_order_pricing_adjustments"
    ADD CONSTRAINT "service_order_pricing_adjustments_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."service_order_pricing"
    ADD CONSTRAINT "service_order_pricing_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."service_order_pricing"
    ADD CONSTRAINT "service_order_pricing_service_order_id_version_key" UNIQUE ("service_order_id", "version");



ALTER TABLE ONLY "public"."service_order_priorities"
    ADD CONSTRAINT "service_order_priorities_organization_id_code_key" UNIQUE NULLS NOT DISTINCT ("organization_id", "code");



ALTER TABLE ONLY "public"."service_order_priorities"
    ADD CONSTRAINT "service_order_priorities_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."service_order_statuses"
    ADD CONSTRAINT "service_order_statuses_code_key" UNIQUE ("code");



ALTER TABLE ONLY "public"."service_order_statuses"
    ADD CONSTRAINT "service_order_statuses_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."service_order_time_entries"
    ADD CONSTRAINT "service_order_time_entries_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."service_order_warranties"
    ADD CONSTRAINT "service_order_warranties_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."service_order_warranties"
    ADD CONSTRAINT "service_order_warranties_service_order_id_key" UNIQUE ("service_order_id");
...
ALTER TABLE ONLY "public"."customer_device_imeis"
    ADD CONSTRAINT "uq_customer_device_imeis_device_position" UNIQUE ("fk_customer_device_id", "position");



ALTER TABLE ONLY "public"."customer_device_imeis"
    ADD CONSTRAINT "uq_customer_device_imeis_device_value" UNIQUE ("fk_customer_device_id", "imei");



ALTER TABLE ONLY "public"."customer_device_imeis"
    ADD CONSTRAINT "uq_customer_device_imeis_organization_value" UNIQUE ("fk_organizacion_id", "imei");
...
ALTER TABLE ONLY "public"."device_receptions"
    ADD CONSTRAINT "uq_device_receptions_id_organization" UNIQUE ("id", "fk_organizacion_id");
...
ALTER TABLE ONLY "public"."motherboard_chipsets"
    ADD CONSTRAINT "uq_motherboard_chipsets" UNIQUE ("fk_processor_socket_id", "code");
...
ALTER TABLE ONLY "public"."processor_sockets"
    ADD CONSTRAINT "uq_processor_sockets" UNIQUE ("platform", "code");
...
ALTER TABLE ONLY "public"."service_orders"
    ADD CONSTRAINT "uq_service_orders_id_org" UNIQUE ("id", "organization_id");



ALTER TABLE ONLY "public"."service_orders"
    ADD CONSTRAINT "uq_service_orders_number" UNIQUE ("organization_id", "order_number");



ALTER TABLE ONLY "public"."service_orders"
    ADD CONSTRAINT "uq_service_orders_reception" UNIQUE ("reception_id");
...
CREATE INDEX "idx_motherboard_models_chipset" ON "public"."motherboard_models" USING "btree" ("fk_motherboard_chipset_id");



CREATE INDEX "idx_motherboard_models_form_factor" ON "public"."motherboard_models" USING "btree" ("fk_motherboard_form_factor_id");



CREATE INDEX "idx_motherboard_models_ram_type" ON "public"."motherboard_models" USING "btree" ("fk_ram_type_id");



CREATE INDEX "idx_motherboard_models_search_priority" ON "public"."motherboard_models" USING "btree" ("search_priority" DESC);



CREATE INDEX "idx_motherboard_models_socket" ON "public"."motherboard_models" USING "btree" ("fk_processor_socket_id");



CREATE INDEX "idx_service_orders_org_status" ON "public"."service_orders" USING "btree" ("organization_id", "status_id", "opened_at" DESC);



CREATE INDEX "idx_so_assignments_technician" ON "public"."service_order_assignments" USING "btree" ("technician_user_id", "assigned_at" DESC);



CREATE INDEX "idx_so_expenses_order" ON "public"."service_order_expenses" USING "btree" ("service_order_id");



CREATE INDEX "idx_so_history_order" ON "public"."service_order_status_history" USING "btree" ("service_order_id", "changed_at" DESC);



CREATE INDEX "idx_so_parts_order" ON "public"."service_order_parts" USING "btree" ("service_order_id");



CREATE INDEX "idx_so_payments_order" ON "public"."service_order_payments" USING "btree" ("service_order_id", "created_at" DESC);



CREATE INDEX "idx_so_pricing_order" ON "public"."service_order_pricing" USING "btree" ("service_order_id", "version" DESC);



CREATE INDEX "idx_so_tasks_order_status" ON "public"."service_order_tasks" USING "btree" ("service_order_id", "status");



CREATE INDEX "idx_so_time_order" ON "public"."service_order_time_entries" USING "btree" ("service_order_id", "started_at" DESC);
...
CREATE INDEX "ix_customer_device_imeis_device" ON "public"."customer_device_imeis" USING "btree" ("fk_customer_device_id");
...
CREATE UNIQUE INDEX "uq_service_order_active_assignment" ON "public"."service_order_assignments" USING "btree" ("service_order_id", "technician_user_id", "assignment_role") WHERE ("unassigned_at" IS NULL);



CREATE UNIQUE INDEX "uq_technician_open_timer" ON "public"."service_order_time_entries" USING "btree" ("technician_user_id") WHERE ("ended_at" IS NULL);
...
CREATE OR REPLACE TRIGGER "trg_service_orders_validate_technician" BEFORE INSERT OR UPDATE OF "primary_technician_id", "organization_id" ON "public"."service_orders" FOR EACH ROW EXECUTE FUNCTION "public"."validate_service_order_technician"();



CREATE OR REPLACE TRIGGER "trg_so_assignments_validate_technician" BEFORE INSERT OR UPDATE OF "technician_user_id", "organization_id" ON "public"."service_order_assignments" FOR EACH ROW EXECUTE FUNCTION "public"."validate_service_order_technician"();



CREATE OR REPLACE TRIGGER "trg_so_tasks_validate_technician" BEFORE INSERT OR UPDATE OF "assigned_technician_id", "organization_id" ON "public"."service_order_tasks" FOR EACH ROW EXECUTE FUNCTION "public"."validate_service_order_technician"();



CREATE OR REPLACE TRIGGER "trg_so_time_validate_technician" BEFORE INSERT OR UPDATE OF "technician_user_id", "organization_id" ON "public"."service_order_time_entries" FOR EACH ROW EXECUTE FUNCTION "public"."validate_service_order_technician"();
...
ALTER TABLE ONLY "public"."customer_communications"
    ADD CONSTRAINT "customer_communications_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE RESTRICT;
...
ALTER TABLE ONLY "public"."customer_device_imeis"
    ADD CONSTRAINT "customer_device_imeis_fk_customer_device_id_fkey" FOREIGN KEY ("fk_customer_device_id") REFERENCES "public"."customer_devices"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."customer_device_imeis"
    ADD CONSTRAINT "customer_device_imeis_fk_organizacion_id_fkey" FOREIGN KEY ("fk_organizacion_id") REFERENCES "public"."organizations"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."customer_device_mobile_specs"
    ADD CONSTRAINT "customer_device_mobile_specs_fk_customer_device_id_fkey" FOREIGN KEY ("fk_customer_device_id") REFERENCES "public"."customer_devices"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."customer_device_mobile_specs"
    ADD CONSTRAINT "customer_device_mobile_specs_fk_organizacion_id_fkey" FOREIGN KEY ("fk_organizacion_id") REFERENCES "public"."organizations"("id") ON DELETE RESTRICT;
...
ALTER TABLE ONLY "public"."customer_communications"
    ADD CONSTRAINT "fk_customer_communications_customer_org" FOREIGN KEY ("customer_id", "organization_id") REFERENCES "public"."customers"("id", "organization_id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."customer_communications"
    ADD CONSTRAINT "fk_customer_communications_order_org" FOREIGN KEY ("service_order_id", "organization_id") REFERENCES "public"."service_orders"("id", "organization_id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."service_orders"
    ADD CONSTRAINT "fk_service_orders_reception_org" FOREIGN KEY ("reception_id", "organization_id") REFERENCES "public"."device_receptions"("id", "fk_organizacion_id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_order_assignments"
    ADD CONSTRAINT "fk_so_assignments_order_org" FOREIGN KEY ("service_order_id", "organization_id") REFERENCES "public"."service_orders"("id", "organization_id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."service_order_deliveries"
    ADD CONSTRAINT "fk_so_delivery_order_org" FOREIGN KEY ("service_order_id", "organization_id") REFERENCES "public"."service_orders"("id", "organization_id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_order_expenses"
    ADD CONSTRAINT "fk_so_expenses_order_org" FOREIGN KEY ("service_order_id", "organization_id") REFERENCES "public"."service_orders"("id", "organization_id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."service_order_parts"
    ADD CONSTRAINT "fk_so_parts_order_org" FOREIGN KEY ("service_order_id", "organization_id") REFERENCES "public"."service_orders"("id", "organization_id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."service_order_payments"
    ADD CONSTRAINT "fk_so_payments_order_org" FOREIGN KEY ("service_order_id", "organization_id") REFERENCES "public"."service_orders"("id", "organization_id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_order_pricing"
    ADD CONSTRAINT "fk_so_pricing_order_org" FOREIGN KEY ("service_order_id", "organization_id") REFERENCES "public"."service_orders"("id", "organization_id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."service_order_status_history"
    ADD CONSTRAINT "fk_so_status_history_order_org" FOREIGN KEY ("service_order_id", "organization_id") REFERENCES "public"."service_orders"("id", "organization_id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."service_order_tasks"
    ADD CONSTRAINT "fk_so_tasks_order_org" FOREIGN KEY ("service_order_id", "organization_id") REFERENCES "public"."service_orders"("id", "organization_id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."service_order_time_entries"
    ADD CONSTRAINT "fk_so_time_order_org" FOREIGN KEY ("service_order_id", "organization_id") REFERENCES "public"."service_orders"("id", "organization_id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."service_order_warranties"
    ADD CONSTRAINT "fk_so_warranty_order_org" FOREIGN KEY ("service_order_id", "organization_id") REFERENCES "public"."service_orders"("id", "organization_id") ON DELETE RESTRICT;
...
ALTER TABLE ONLY "public"."motherboard_chipsets"
    ADD CONSTRAINT "motherboard_chipsets_fk_processor_socket_id_fkey" FOREIGN KEY ("fk_processor_socket_id") REFERENCES "public"."processor_sockets"("id") ON DELETE RESTRICT;
...
ALTER TABLE ONLY "public"."motherboard_models"
    ADD CONSTRAINT "motherboard_models_fk_motherboard_chipset_id_fkey" FOREIGN KEY ("fk_motherboard_chipset_id") REFERENCES "public"."motherboard_chipsets"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."motherboard_models"
    ADD CONSTRAINT "motherboard_models_fk_motherboard_form_factor_id_fkey" FOREIGN KEY ("fk_motherboard_form_factor_id") REFERENCES "public"."motherboard_form_factors"("id") ON DELETE RESTRICT;
...
ALTER TABLE ONLY "public"."motherboard_models"
    ADD CONSTRAINT "motherboard_models_fk_processor_socket_id_fkey" FOREIGN KEY ("fk_processor_socket_id") REFERENCES "public"."processor_sockets"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."motherboard_models"
    ADD CONSTRAINT "motherboard_models_fk_ram_type_id_fkey" FOREIGN KEY ("fk_ram_type_id") REFERENCES "public"."ram_types"("id") ON DELETE RESTRICT;
...
ALTER TABLE ONLY "public"."organization_labor_rates"
    ADD CONSTRAINT "organization_labor_rates_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."organization_labor_rates"
    ADD CONSTRAINT "organization_labor_rates_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."service_complexity_levels"
    ADD CONSTRAINT "service_complexity_levels_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."service_order_assignments"
    ADD CONSTRAINT "service_order_assignments_assigned_by_fkey" FOREIGN KEY ("assigned_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."service_order_assignments"
    ADD CONSTRAINT "service_order_assignments_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_order_assignments"
    ADD CONSTRAINT "service_order_assignments_technician_user_id_fkey" FOREIGN KEY ("technician_user_id") REFERENCES "auth"."users"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_order_deliveries"
    ADD CONSTRAINT "service_order_deliveries_delivered_by_fkey" FOREIGN KEY ("delivered_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."service_order_deliveries"
    ADD CONSTRAINT "service_order_deliveries_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_order_expenses"
    ADD CONSTRAINT "service_order_expenses_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."service_order_expenses"
    ADD CONSTRAINT "service_order_expenses_inventory_item_id_fkey" FOREIGN KEY ("inventory_item_id") REFERENCES "public"."inventory_items"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."service_order_expenses"
    ADD CONSTRAINT "service_order_expenses_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_order_expenses"
    ADD CONSTRAINT "service_order_expenses_supplier_id_fkey" FOREIGN KEY ("supplier_id") REFERENCES "public"."suppliers"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."service_order_parts"
    ADD CONSTRAINT "service_order_parts_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."service_order_parts"
    ADD CONSTRAINT "service_order_parts_installed_by_fkey" FOREIGN KEY ("installed_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."service_order_parts"
    ADD CONSTRAINT "service_order_parts_inventory_item_id_fkey" FOREIGN KEY ("inventory_item_id") REFERENCES "public"."inventory_items"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_order_parts"
    ADD CONSTRAINT "service_order_parts_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_order_payments"
    ADD CONSTRAINT "service_order_payments_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_order_payments"
    ADD CONSTRAINT "service_order_payments_payment_method_id_fkey" FOREIGN KEY ("payment_method_id") REFERENCES "public"."payment_methods"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_order_payments"
    ADD CONSTRAINT "service_order_payments_recorded_by_fkey" FOREIGN KEY ("recorded_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."service_order_pricing_adjustments"
    ADD CONSTRAINT "service_order_pricing_adjustments_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."service_order_pricing_adjustments"
    ADD CONSTRAINT "service_order_pricing_adjustments_service_order_pricing_id_fkey" FOREIGN KEY ("service_order_pricing_id") REFERENCES "public"."service_order_pricing"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."service_order_pricing"
    ADD CONSTRAINT "service_order_pricing_calculated_by_fkey" FOREIGN KEY ("calculated_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."service_order_pricing"
    ADD CONSTRAINT "service_order_pricing_labor_rate_id_fkey" FOREIGN KEY ("labor_rate_id") REFERENCES "public"."organization_labor_rates"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_order_pricing"
    ADD CONSTRAINT "service_order_pricing_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_order_priorities"
    ADD CONSTRAINT "service_order_priorities_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."service_order_status_history"
    ADD CONSTRAINT "service_order_status_history_changed_by_fkey" FOREIGN KEY ("changed_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."service_order_status_history"
    ADD CONSTRAINT "service_order_status_history_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_order_status_history"
    ADD CONSTRAINT "service_order_status_history_status_id_fkey" FOREIGN KEY ("status_id") REFERENCES "public"."service_order_statuses"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_order_tasks"
    ADD CONSTRAINT "service_order_tasks_assigned_technician_id_fkey" FOREIGN KEY ("assigned_technician_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."service_order_tasks"
    ADD CONSTRAINT "service_order_tasks_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."service_order_tasks"
    ADD CONSTRAINT "service_order_tasks_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_order_tasks"
    ADD CONSTRAINT "service_order_tasks_technical_service_id_fkey" FOREIGN KEY ("technical_service_id") REFERENCES "public"."technical_services"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."service_order_time_entries"
    ADD CONSTRAINT "service_order_time_entries_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_order_time_entries"
    ADD CONSTRAINT "service_order_time_entries_task_id_fkey" FOREIGN KEY ("task_id") REFERENCES "public"."service_order_tasks"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."service_order_time_entries"
    ADD CONSTRAINT "service_order_time_entries_technician_user_id_fkey" FOREIGN KEY ("technician_user_id") REFERENCES "auth"."users"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_order_warranties"
    ADD CONSTRAINT "service_order_warranties_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."service_order_warranties"
    ADD CONSTRAINT "service_order_warranties_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_orders"
    ADD CONSTRAINT "service_orders_complexity_id_fkey" FOREIGN KEY ("complexity_id") REFERENCES "public"."service_complexity_levels"("id") ON DELETE RESTRICT;
...
ALTER TABLE ONLY "public"."service_orders"
    ADD CONSTRAINT "service_orders_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_orders"
    ADD CONSTRAINT "service_orders_primary_technician_id_fkey" FOREIGN KEY ("primary_technician_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."service_orders"
    ADD CONSTRAINT "service_orders_priority_id_fkey" FOREIGN KEY ("priority_id") REFERENCES "public"."service_order_priorities"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."service_orders"
    ADD CONSTRAINT "service_orders_status_id_fkey" FOREIGN KEY ("status_id") REFERENCES "public"."service_order_statuses"("id") ON DELETE RESTRICT;
...
CREATE POLICY "complexity_owner_manage" ON "public"."service_complexity_levels" TO "authenticated" USING ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = 'OWNER'::"public"."app_role"))) WITH CHECK ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = 'OWNER'::"public"."app_role")));
...
CREATE POLICY "customer_communications_tenant_operate" ON "public"."customer_communications" TO "authenticated" USING ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"])))) WITH CHECK ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"]))));
...
CREATE POLICY "customer_device_imeis_read" ON "public"."customer_device_imeis" FOR SELECT TO "authenticated" USING (("fk_organizacion_id" = "public"."current_organization_id"()));
...
CREATE POLICY "customer_device_mobile_specs_read" ON "public"."customer_device_mobile_specs" FOR SELECT TO "authenticated" USING (("fk_organizacion_id" = "public"."current_organization_id"()));
...
CREATE POLICY "gpu_brands_read" ON "public"."gpu_brands" FOR SELECT TO "authenticated" USING ("is_active");
...
CREATE POLICY "gpu_families_read" ON "public"."gpu_families" FOR SELECT TO "authenticated" USING ("is_active");
...
CREATE POLICY "gpu_models_read" ON "public"."gpu_models" FOR SELECT TO "authenticated" USING ("is_active");
...
CREATE POLICY "labor_rates_owner_all" ON "public"."organization_labor_rates" TO "authenticated" USING ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = 'OWNER'::"public"."app_role"))) WITH CHECK ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = 'OWNER'::"public"."app_role")));
...
ALTER TABLE "public"."motherboard_chipsets" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "motherboard_chipsets_authenticated_read" ON "public"."motherboard_chipsets" FOR SELECT TO "authenticated" USING (true);



ALTER TABLE "public"."motherboard_form_factors" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "motherboard_form_factors_authenticated_read" ON "public"."motherboard_form_factors" FOR SELECT TO "authenticated" USING (true);
...
ALTER TABLE "public"."organization_labor_rates" ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "payment_methods_owner_manage" ON "public"."payment_methods" TO "authenticated" USING ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = 'OWNER'::"public"."app_role"))) WITH CHECK ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = 'OWNER'::"public"."app_role")));



CREATE POLICY "payment_methods_read" ON "public"."payment_methods" FOR SELECT TO "authenticated" USING (("is_active" AND (("organization_id" IS NULL) OR ("organization_id" = "public"."current_organization_id"()))));



CREATE POLICY "payments_owner_write" ON "public"."service_order_payments" TO "authenticated" USING ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = 'OWNER'::"public"."app_role"))) WITH CHECK ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = 'OWNER'::"public"."app_role")));



CREATE POLICY "payments_tenant_read" ON "public"."service_order_payments" FOR SELECT TO "authenticated" USING ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"]))));



CREATE POLICY "pricing_adjustments_owner_write" ON "public"."service_order_pricing_adjustments" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."service_order_pricing" "p"
  WHERE (("p"."id" = "service_order_pricing_adjustments"."service_order_pricing_id") AND ("p"."organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = 'OWNER'::"public"."app_role"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."service_order_pricing" "p"
  WHERE (("p"."id" = "service_order_pricing_adjustments"."service_order_pricing_id") AND ("p"."organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = 'OWNER'::"public"."app_role")))));



CREATE POLICY "pricing_adjustments_read" ON "public"."service_order_pricing_adjustments" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."service_order_pricing" "p"
  WHERE (("p"."id" = "service_order_pricing_adjustments"."service_order_pricing_id") AND ("p"."organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"]))))));



CREATE POLICY "pricing_owner_write" ON "public"."service_order_pricing" TO "authenticated" USING ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = 'OWNER'::"public"."app_role"))) WITH CHECK ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = 'OWNER'::"public"."app_role")));



CREATE POLICY "pricing_tenant_read" ON "public"."service_order_pricing" FOR SELECT TO "authenticated" USING ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"]))));



CREATE POLICY "priority_owner_manage" ON "public"."service_order_priorities" TO "authenticated" USING ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = 'OWNER'::"public"."app_role"))) WITH CHECK ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = 'OWNER'::"public"."app_role")));
...
ALTER TABLE "public"."processor_sockets" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "processor_sockets_authenticated_read" ON "public"."processor_sockets" FOR SELECT TO "authenticated" USING (true);
...
ALTER TABLE "public"."service_complexity_levels" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."service_order_assignments" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "service_order_assignments_tenant_operate" ON "public"."service_order_assignments" TO "authenticated" USING ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"])))) WITH CHECK ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"]))));
...
CREATE POLICY "service_order_deliveries_tenant_operate" ON "public"."service_order_deliveries" TO "authenticated" USING ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"])))) WITH CHECK ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"]))));
...
CREATE POLICY "service_order_expenses_tenant_operate" ON "public"."service_order_expenses" TO "authenticated" USING ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"])))) WITH CHECK ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"]))));
...
CREATE POLICY "service_order_parts_tenant_operate" ON "public"."service_order_parts" TO "authenticated" USING ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"])))) WITH CHECK ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"]))));
...
ALTER TABLE "public"."service_order_pricing" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."service_order_pricing_adjustments" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."service_order_priorities" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."service_order_status_history" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "service_order_status_history_tenant_operate" ON "public"."service_order_status_history" TO "authenticated" USING ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"])))) WITH CHECK ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"]))));
...
CREATE POLICY "service_order_tasks_tenant_operate" ON "public"."service_order_tasks" TO "authenticated" USING ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"])))) WITH CHECK ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"]))));



ALTER TABLE "public"."service_order_time_entries" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "service_order_time_entries_tenant_operate" ON "public"."service_order_time_entries" TO "authenticated" USING ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"])))) WITH CHECK ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"]))));
...
CREATE POLICY "service_order_warranties_tenant_operate" ON "public"."service_order_warranties" TO "authenticated" USING ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"])))) WITH CHECK ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"]))));
...
CREATE POLICY "service_orders_tenant_operate" ON "public"."service_orders" TO "authenticated" USING ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"])))) WITH CHECK ((("organization_id" = "public"."current_organization_id"()) AND ("public"."current_app_role"() = ANY (ARRAY['OWNER'::"public"."app_role", 'TECHNICIAN'::"public"."app_role"]))));



CREATE POLICY "so_complexity_read" ON "public"."service_complexity_levels" FOR SELECT TO "authenticated" USING (("is_active" AND (("organization_id" IS NULL) OR ("organization_id" = "public"."current_organization_id"()))));



CREATE POLICY "so_priority_read" ON "public"."service_order_priorities" FOR SELECT TO "authenticated" USING (("is_active" AND (("organization_id" IS NULL) OR ("organization_id" = "public"."current_organization_id"()))));



CREATE POLICY "so_status_read" ON "public"."service_order_statuses" FOR SELECT TO "authenticated" USING ("is_active");
...
REVOKE ALL ON FUNCTION "public"."assert_superadmin_catalog"() FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."assert_superadmin_catalog"() TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."confirmar_recepcion_dispositivo"("p_dispositivo_cliente_id" "uuid", "p_problema_informado" "text", "p_observaciones" "text", "p_resultados" "jsonb", "p_intake_metadata" "jsonb") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."confirmar_recepcion_dispositivo"("p_dispositivo_cliente_id" "uuid", "p_problema_informado" "text", "p_observaciones" "text", "p_resultados" "jsonb", "p_intake_metadata" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."confirmar_recepcion_dispositivo"("p_dispositivo_cliente_id" "uuid", "p_problema_informado" "text", "p_observaciones" "text", "p_resultados" "jsonb", "p_intake_metadata" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."is_valid_imei"("p_imei" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."is_valid_imei"("p_imei" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_valid_imei"("p_imei" "text") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."master_catalog_health"("p_device_type_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."master_catalog_health"("p_device_type_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."master_catalog_health"("p_device_type_id" "uuid") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."superadmin_create_device_brand"("p_name" "text", "p_device_type_ids" "uuid"[]) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."superadmin_create_device_brand"("p_name" "text", "p_device_type_ids" "uuid"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."superadmin_create_device_brand"("p_name" "text", "p_device_type_ids" "uuid"[]) TO "service_role";



REVOKE ALL ON FUNCTION "public"."superadmin_create_device_color"("p_name" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."superadmin_create_device_color"("p_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."superadmin_create_device_color"("p_name" "text") TO "service_role";



REVOKE ALL ON FUNCTION "public"."superadmin_create_device_model"("p_device_type_id" "uuid", "p_brand_id" "uuid", "p_name" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."superadmin_create_device_model"("p_device_type_id" "uuid", "p_brand_id" "uuid", "p_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."superadmin_create_device_model"("p_device_type_id" "uuid", "p_brand_id" "uuid", "p_name" "text") TO "service_role";



REVOKE ALL ON FUNCTION "public"."superadmin_create_device_variant"("p_model_id" "uuid", "p_name" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."superadmin_create_device_variant"("p_model_id" "uuid", "p_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."superadmin_create_device_variant"("p_model_id" "uuid", "p_name" "text") TO "service_role";



REVOKE ALL ON FUNCTION "public"."superadmin_create_gpu_brand"("p_name" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."superadmin_create_gpu_brand"("p_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."superadmin_create_gpu_brand"("p_name" "text") TO "service_role";



REVOKE ALL ON FUNCTION "public"."superadmin_create_gpu_family"("p_brand_id" "uuid", "p_name" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."superadmin_create_gpu_family"("p_brand_id" "uuid", "p_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."superadmin_create_gpu_family"("p_brand_id" "uuid", "p_name" "text") TO "service_role";



REVOKE ALL ON FUNCTION "public"."superadmin_create_gpu_model"("p_family_id" "uuid", "p_name" "text", "p_graphics_kind" "text", "p_notebook" boolean, "p_desktop" boolean) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."superadmin_create_gpu_model"("p_family_id" "uuid", "p_name" "text", "p_graphics_kind" "text", "p_notebook" boolean, "p_desktop" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."superadmin_create_gpu_model"("p_family_id" "uuid", "p_name" "text", "p_graphics_kind" "text", "p_notebook" boolean, "p_desktop" boolean) TO "service_role";



REVOKE ALL ON FUNCTION "public"."superadmin_create_motherboard_manufacturer"("p_name" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."superadmin_create_motherboard_manufacturer"("p_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."superadmin_create_motherboard_manufacturer"("p_name" "text") TO "service_role";



REVOKE ALL ON FUNCTION "public"."superadmin_create_motherboard_model"("p_manufacturer_id" "uuid", "p_name" "text", "p_device_type_ids" "uuid"[]) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."superadmin_create_motherboard_model"("p_manufacturer_id" "uuid", "p_name" "text", "p_device_type_ids" "uuid"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."superadmin_create_motherboard_model"("p_manufacturer_id" "uuid", "p_name" "text", "p_device_type_ids" "uuid"[]) TO "service_role";



REVOKE ALL ON FUNCTION "public"."superadmin_create_processor_model"("p_brand_id" "uuid", "p_family_id" "uuid", "p_generation_id" "uuid", "p_name" "text", "p_notebook" boolean, "p_desktop" boolean) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."superadmin_create_processor_model"("p_brand_id" "uuid", "p_family_id" "uuid", "p_generation_id" "uuid", "p_name" "text", "p_notebook" boolean, "p_desktop" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."superadmin_create_processor_model"("p_brand_id" "uuid", "p_family_id" "uuid", "p_generation_id" "uuid", "p_name" "text", "p_notebook" boolean, "p_desktop" boolean) TO "service_role";



REVOKE ALL ON FUNCTION "public"."superadmin_create_ram_speed"("p_ram_type_id" "uuid", "p_mhz" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."superadmin_create_ram_speed"("p_ram_type_id" "uuid", "p_mhz" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."superadmin_create_ram_speed"("p_ram_type_id" "uuid", "p_mhz" integer) TO "service_role";



REVOKE ALL ON FUNCTION "public"."superadmin_create_ram_type"("p_code" "text", "p_name" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."superadmin_create_ram_type"("p_code" "text", "p_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."superadmin_create_ram_type"("p_code" "text", "p_name" "text") TO "service_role";



REVOKE ALL ON FUNCTION "public"."superadmin_create_reception_control"("p_key" "text", "p_label" "text", "p_description" "text", "p_critical" boolean, "p_device_type_ids" "uuid"[]) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."superadmin_create_reception_control"("p_key" "text", "p_label" "text", "p_description" "text", "p_critical" boolean, "p_device_type_ids" "uuid"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."superadmin_create_reception_control"("p_key" "text", "p_label" "text", "p_description" "text", "p_critical" boolean, "p_device_type_ids" "uuid"[]) TO "service_role";



REVOKE ALL ON FUNCTION "public"."superadmin_create_storage_option"("p_entity" "text", "p_code" "text", "p_name" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."superadmin_create_storage_option"("p_entity" "text", "p_code" "text", "p_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."superadmin_create_storage_option"("p_entity" "text", "p_code" "text", "p_name" "text") TO "service_role";



REVOKE ALL ON FUNCTION "public"."superadmin_set_catalog_active"("p_entity" "text", "p_id" "uuid", "p_active" boolean) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."superadmin_set_catalog_active"("p_entity" "text", "p_id" "uuid", "p_active" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."superadmin_set_catalog_active"("p_entity" "text", "p_id" "uuid", "p_active" boolean) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."validate_service_order_technician"() TO "anon";
GRANT ALL ON FUNCTION "public"."validate_service_order_technician"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."validate_service_order_technician"() TO "service_role";
...
GRANT ALL ON TABLE "public"."customer_device_imeis" TO "service_role";
GRANT SELECT ON TABLE "public"."customer_device_imeis" TO "authenticated";



GRANT ALL ON TABLE "public"."customer_device_mobile_specs" TO "service_role";
GRANT SELECT ON TABLE "public"."customer_device_mobile_specs" TO "authenticated";
...
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."gpu_brands" TO "anon";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."gpu_brands" TO "authenticated";
GRANT ALL ON TABLE "public"."gpu_brands" TO "service_role";



GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."gpu_families" TO "anon";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."gpu_families" TO "authenticated";
GRANT ALL ON TABLE "public"."gpu_families" TO "service_role";



GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."gpu_models" TO "anon";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."gpu_models" TO "authenticated";
...
GRANT ALL ON TABLE "public"."motherboard_chipsets" TO "anon";
GRANT ALL ON TABLE "public"."motherboard_chipsets" TO "authenticated";
GRANT ALL ON TABLE "public"."motherboard_chipsets" TO "service_role";



GRANT ALL ON TABLE "public"."motherboard_form_factors" TO "anon";
GRANT ALL ON TABLE "public"."motherboard_form_factors" TO "authenticated";
GRANT ALL ON TABLE "public"."motherboard_form_factors" TO "service_role";
...
GRANT ALL ON TABLE "public"."organization_labor_rates" TO "anon";
GRANT ALL ON TABLE "public"."organization_labor_rates" TO "authenticated";
GRANT ALL ON TABLE "public"."organization_labor_rates" TO "service_role";
...
GRANT ALL ON TABLE "public"."processor_sockets" TO "anon";
GRANT ALL ON TABLE "public"."processor_sockets" TO "authenticated";
GRANT ALL ON TABLE "public"."processor_sockets" TO "service_role";
...
GRANT ALL ON TABLE "public"."service_complexity_levels" TO "anon";
GRANT ALL ON TABLE "public"."service_complexity_levels" TO "authenticated";
GRANT ALL ON TABLE "public"."service_complexity_levels" TO "service_role";



GRANT ALL ON TABLE "public"."service_order_assignments" TO "anon";
GRANT ALL ON TABLE "public"."service_order_assignments" TO "authenticated";
GRANT ALL ON TABLE "public"."service_order_assignments" TO "service_role";



GRANT ALL ON TABLE "public"."service_order_deliveries" TO "anon";
GRANT ALL ON TABLE "public"."service_order_deliveries" TO "authenticated";
GRANT ALL ON TABLE "public"."service_order_deliveries" TO "service_role";



GRANT ALL ON TABLE "public"."service_order_expenses" TO "anon";
GRANT ALL ON TABLE "public"."service_order_expenses" TO "authenticated";
GRANT ALL ON TABLE "public"."service_order_expenses" TO "service_role";
...
GRANT ALL ON TABLE "public"."service_order_payments" TO "anon";
GRANT ALL ON TABLE "public"."service_order_payments" TO "authenticated";
GRANT ALL ON TABLE "public"."service_order_payments" TO "service_role";



GRANT ALL ON TABLE "public"."service_order_pricing" TO "anon";
GRANT ALL ON TABLE "public"."service_order_pricing" TO "authenticated";
GRANT ALL ON TABLE "public"."service_order_pricing" TO "service_role";



GRANT ALL ON TABLE "public"."service_order_pricing_adjustments" TO "anon";
GRANT ALL ON TABLE "public"."service_order_pricing_adjustments" TO "authenticated";
GRANT ALL ON TABLE "public"."service_order_pricing_adjustments" TO "service_role";



GRANT ALL ON TABLE "public"."service_order_priorities" TO "anon";
GRANT ALL ON TABLE "public"."service_order_priorities" TO "authenticated";
GRANT ALL ON TABLE "public"."service_order_priorities" TO "service_role";



GRANT ALL ON TABLE "public"."service_order_status_history" TO "anon";
GRANT ALL ON TABLE "public"."service_order_status_history" TO "authenticated";
GRANT ALL ON TABLE "public"."service_order_status_history" TO "service_role";



GRANT ALL ON TABLE "public"."service_order_statuses" TO "anon";
GRANT ALL ON TABLE "public"."service_order_statuses" TO "authenticated";
GRANT ALL ON TABLE "public"."service_order_statuses" TO "service_role";



GRANT ALL ON TABLE "public"."service_order_tasks" TO "anon";
GRANT ALL ON TABLE "public"."service_order_tasks" TO "authenticated";
GRANT ALL ON TABLE "public"."service_order_tasks" TO "service_role";



GRANT ALL ON TABLE "public"."service_order_time_entries" TO "anon";
GRANT ALL ON TABLE "public"."service_order_time_entries" TO "authenticated";
GRANT ALL ON TABLE "public"."service_order_time_entries" TO "service_role";



GRANT ALL ON TABLE "public"."service_order_warranties" TO "anon";
GRANT ALL ON TABLE "public"."service_order_warranties" TO "authenticated";
GRANT ALL ON TABLE "public"."service_order_warranties" TO "service_role";
